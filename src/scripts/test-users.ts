...
async function testGetUserById(adminToken: string | null) {
...
async function testCreateUser(adminToken: string | null) {
  console.log('\n➕ Testing Create User...');
...
async function testUpdateUser(adminToken: string | null, userId: string | null) {
...
async function testDeleteUser(adminToken: string | null) {
