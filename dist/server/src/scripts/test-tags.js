...
exports.runTagTests = runTagTests;
...
async function testUpdateTag(adminToken, tagId) {
    ...
    try {
        const { status } = await makeRequest('PUT', '/tags/invalid-id', { name: 'Test' }, adminToken);
...
async function testDeleteTag(adminToken) {
